...
class LoscaBoardOfEdSpider(CityScrapersSpider):
    ...
    start_urls = ["https://www.lausd.org/site/RSS.aspx?DomainID=1057&ModuleInstanceID=73805&PageID=18628&PMIID=0"]
    ...
    def _parse_title(self, item):
        ...
        Ex: '9/19/2024 10:00 AM - 1:00 PM Children and Families in Early Education Committee'
        Remove timestamp from string and return title.
        """
        raw = item.css('title::text').get()
        title = ' '.join(raw.split()[6:-1])
        return title
