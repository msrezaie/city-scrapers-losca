...
test_response = file_response(
    ...
    url="https://lacity.primegov.com/api/v2/PublicPortal/ListUpcomingMeetings?_=1726255032697",
)
...
def test_id():
    assert parsed_items[0]["id"] == "losca_City_Council/202410010830/x/personnel_audits_and_hiring_committee"
...
def test_source():
    assert parsed_items[0]["source"] == "https://lacity.primegov.com/api/v2/PublicPortal/ListUpcomingMeetings?_=1726255032697"


def test_links():
    assert parsed_items[0]["links"] == [{
        "title": "video",
        "href": "https://youtube.com/watch?v=ewD_li_BkgU"
    }]
    assert parsed_items[1]["links"] == [{
        "title": "video",
        "href": "https://youtube.com/watch?v=EX00DchXvkA"
    }]
